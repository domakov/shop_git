...
INSERT INTO `tovar` (`id_tovar`, `t_name`, `t_price`, `t_category`, `t_quantity`, `t_sale`, `t_new`, `t_description`) VALUES
	...
	(4, 'Acqua di Parma Iris Nobile\r\n\r\n', 41000, '5', 15, 10, 1, 'Acqua di Parma Iris Nobile - аромат истинной женственности. Этот легкий и свежий цветочный аромат является воплощением элегантности, харизмы и отличного качества – характеристик, хорошо известных поклонникам марки Acqua di Parma. Основой парфюмерной композиции является нота цветка ириса в сочетании с ирисовой древесиной и ирисовым корнем. Богатый букет дополняется звездчатым анисом, сицилийским мандарином и калабрийским бергамотом. «База» состоит из теплых нот кедра, фруктовых оттенков цветка апельсина и благородных ароматов кристаллической амбры и мадагаскарской ванили. В парфюмированной воде композиция дополнена нотами иланг-иланга, дубового мха и пачули'),
