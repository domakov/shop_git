...
-- Дамп данных таблицы db_shop.comment: ~16 rows (приблизительно)
DELETE FROM `comment`;
...
-- Дамп структуры для таблица db_shop.raiting
...
-- Дамп данных таблицы db_shop.raiting: ~0 rows (приблизительно)
DELETE FROM `raiting`;
...
INSERT INTO `subcategory` (`id_subcategory`, `id_category`, `sub_name`) VALUES
	(1, 1, 'Телефон'),
	(2, 1, 'Планшет');
