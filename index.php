      ...
      <div id="product_intro" class="container_12">
        <div id="product_intro_info" class="grid_5">
          ...
          <div style="position: relative; display: none;">
            <h2><a href="product.php">White football trainers</a></h2>
          ...
          <div style="position: relative; display: none;">
            <h2><a href="product.php">Balenciaga Paris</a></h2>
          ...
          <div style="position: relative; display: none;">
            <h2><a href="product.php">Adidas Acqua</a></h2>
          ...
          <div style="position: relative; display: none;">
            <h2><a href="product.php">Panasonic Lumix</a></h2>
